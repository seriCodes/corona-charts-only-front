...
//    data={[1,2,4,5,2,4,4,]}
    ...
    id={chartId1} 
    chartType={'line'} 
    title={"מגמת שינוי במאומתים חדשים וקצב הכפלה"} 
    middleElenet={[<i class="fa fa-info-circle" aria-hidden="true"></i>, " % שינוי בממוצע מאומתים חדשים שבועי, ומספר הימים להכפלת הנדבקים (בסוגריים)"]}
    beginAtZero={false}
